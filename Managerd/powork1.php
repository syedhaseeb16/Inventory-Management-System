...
$rod = mysqli_fetch_array($result);
               ...
               if($rod['m1a']!='0' && $rod['m2a']!='0' && $rod['m3a']!='0')
                   ...
                   if($rod['m1a']=='r' && $rod['stk']=='ok'){?>
                                                   ...
                                                   <Button name="am1" style="color:white; font-size: .8em; background-color: green; " class="item" data-toggle="tooltip" data-placement="top" title="Approve">Approve
                                                     </Button>

                                                   </div>
                                                        </div>
                                                        <div class="col-sm-1">
                                                          <Button name="rm1" style="color:white; font-size: .8em; background-color: red; " class="item" data-toggle="tooltip" data-placement="top" title="Approve">Return
                                                     </Button>
                                                        </div>
                                                      </div>
                                                    </div>
                 ...
                 if($rod['m1a']!='0' && $rod['m2a']=='0' && $rod['m3a']=='0')
                   ...
                   if($rod['m1a']=='r' && $rod['stk']=='ok'){?>
                                          <form action="updatedeleteitem.php?update=<?php echo $pon;?>"   method="post">
                                                   ...
                                                   <Button name="am1f" style="color:white; font-size: .8em; background-color: green; " class="item" data-toggle="tooltip" data-placement="top" title="Approve">Approve
                                                     </Button>
                                                   </div>
                                                        </div>
                                                        <div class="col-sm-1">
