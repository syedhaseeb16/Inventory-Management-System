...
$rod = mysqli_fetch_array($result);
               ...
               if($rod['m1a']!='0' && $rod['m2a']!='0' && $rod['m3a']!='0')
                   ...
                   if($rod['m2a']=='r' && $rod['m1a']=='ok'){?>
                                                   ...
                                                   <Button name="am2" style="color:white; font-size: .8em; background-color: green; " class="item" data-toggle="tooltip" data-placement="top" title="Approve">Approve
                                                     </Button>

                                                   </div>
                                                        </div>
                                                        <div class="col-sm-1">
                                                          <Button name="rm2" style="color:white; font-size: .8em; background-color: red; " class="item" data-toggle="tooltip" data-placement="top" title="Approve">Return
                                                     </Button>
                                                        </div>
                                                      </div>
                                                    </div>
                 ...
                 if($rod['m1a']!='0' && $rod['m2a']!='0' && $rod['m3a']=='0')
                   ...
                   if($rod['m2a']=='r' && $rod['m1a']=='ok'){?>
                                                <form action="updatedeleteitem.php?update=<?php echo $pon ;?>"   method="post">
                                                   ...
                                                   <Button name="am2f" style="color:white; font-size: .8em; background-color: green; " class="item" data-toggle="tooltip" data-placement="top" title="Approve">Approve
                                                     </Button>
