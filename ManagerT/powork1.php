<?php  
session_start();
if(isset($_SESSION["id"]) && $_SESSION["type"]==6)
                          {          
...
<body id="page-top">
 ...
 <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
    ...
    <a class="navbar-brand mr-1" href="#">Manager L3 Panel</a>
...
$rod = mysqli_fetch_array($result);
               ...
               if($rod['m1a']!='0' && $rod['m2a']!='0' && $rod['m3a']!='0')
                   ...
                   if($rod['m3a']=='r' && $rod['m2a']=='ok'){?>
                                                                       <form action="updatedeleteitem.php?update=<?php echo $pon ;?>"   method="post">
                                                    <div class="container">
                                                      <div class="row">
                                                        <div class="col-sm-5">
                                                          Remarks:<input type="text" size="40" required="" name="remarksm1">
                                                        </div>
                                                        <div class="col-sm-1">
                                                          <div class="table-data-feature">
                                                
                                                   <Button name="am3f" style="color:white; font-size: .8em; background-color: green; " class="item" data-toggle="tooltip" data-placement="top" title="Approve">Approve
                                                     </Button>

                                                   </div>
                                                        </div>
                                                        <div class="col-sm-1">
                                                          <Button name="rm3" style="color:white; font-size: .8em; background-color: red; " class="item" data-toggle="tooltip" data-placement="top" title="Approve">Return
                                                     </Button>
                                                        </div>
                                                      </div>
                                                    </div>
                 ...
                 if($rod['m3a']=='ok'){?>
                                            ...
                                            <div class="table-data-feature">
                                                   ...
                                                   <a href='updatedeleteitem.php?update=<?php echo $pon ;?>'><Button name="am1" style="color:white; font-size: .8em; background-color: green; " disabled class="item" data-toggle="tooltip" data-placement="top" title="Approve">Approve
                                                      ...
                                                      <a href='updatedeleteitem.php?update=<?php echo $pon ;?>'><Button name="rm1" style="color:white; font-size: .8em; background-color: green;" disabled class="item" data-toggle="tooltip" data-placement="top" title="Approve">Return
                                                     </Button></a>
                   ...
                   if($rod['m3a']=='r' && $rod['m2a']=='ok'){?>
                                                <form action="updatedeleteitem.php?update=<?php echo $pon ;?>"   method="post">
                                                    <div class="container">
                                                      <div class="row">
                                                        <div class="col-sm-5">
                                                          Remarks:<input type="text" size="40" name="remarksm1">
                                                        </div>
                                                        <div class="col-sm-1">
                                                          <div class="table-data-feature">
                                                
                                                   <Button name="am3" style="color:white; font-size: .8em; background-color: green; " class="item" data-toggle="tooltip" data-placement="top" title="Approve">Approve
                                                     </Button>
