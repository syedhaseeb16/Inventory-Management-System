...
<?php
  ...
  ?>
  <form action="alltrans.php"   method="post" > 



  <p style="color:black ; " >Request No :&nbsp;<INPUT type="text" id="project" placeholder="Request #" value="" size="10" style="font-size: 10pt"  type="text" name="req"/>  UserID :   &nbsp;&nbsp;
<input id="2" value="" size="15" style="font-size: 10pt" placeholder="User ID" name="userid" type="text" list="userid"/> 
            <?php  
            include('../config.php');
...
//100
 ...
 $s="select * from users_requests WHERE ReqNo='$request_1' ";
...
//110
 ...
 $s="select * from users_requests WHERE ReqNo='$request_1' AND UserId='$u_id'";
}
//111
else if($_POST['req']!="" && $_POST['userid']!=""&&$_POST['pname']!="" ){
...
$paymentDate=$ro['DOI'];
                              ...
                              $curr_req=$ro["ReqNo"];
                              $s1="select * from store_outward WHERE request_no='$curr_req'";
