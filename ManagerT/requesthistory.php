                    ...
                    <?php  
                       include('../config.php');
                        ...
                        $q=mysqli_query($conn,$s); 
                            ...
                            while($ro=mysqli_fetch_array($q))
                            {
                              if( $ro['FStatus']=="Issued"  || $ro['FStatus']=="NotIssued" || $ro['FStatus']=="Partial"   ){
                           ?> 
                           
                    <tr>
                      <td>  <a href='reqgenp.php?id=<?php echo $ro['ReqNo']; ?> &name= <?php echo $ro['UserName']; ?> &dor= <?php echo $ro['DORequest']; ?> &dod=<?php echo $ro['DORequirement']; ?>'><?php echo  $ro["ReqNo"];  ?> </a></td>
