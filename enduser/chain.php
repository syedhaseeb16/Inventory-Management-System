    ...
    <ul class="sidebar navbar-nav">
      ...
      <li class="nav-item ">
        ...
        <a class="nav-link" href="requestfornewitem.php">
          <i class="fas fa-fw fa-table"></i>
          <span>Select new Supervisor</span></a>
      </li>
    </ul>
    ...
    <div class="card card-login mx-auto mt-5">
      ...
      <div class="card-body">
        <div class="text-center mb-4">
          ...
          <p>Select Your Supervisor For Approval</p>
        </div>

        
        <?php $req=0; if(isset($_GET['reqno']) ){ $req=$_GET['reqno'];    }              ?>

        <form action="getdata.php?reqno=<?php echo $req ?>"  Method="POST">
          <div class="form-group">
            <div class="form-label-group">
              <input type="text" id="inputEmail" class="form-control" name="super" type="text" list="super" placeholder="" required="required" autofocus="autofocus">
          ...
          <button class="btn btn-primary btn-block" name="req" value="Submit Request"> Change Supervisor </button>

            <a class="btn btn-primary btn-block" href="enduser.php">Cancel</a>
