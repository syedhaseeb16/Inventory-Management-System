                    ...
                    <?php  
                       include('../config.php');
                        ...
                        $q=mysqli_query($conn,$s); 
                            ...
                            while($ro=mysqli_fetch_array($q))
                            {
                              if($ro['UserId']==$_SESSION["id"] && $ro['FStatus']=="Issued" || $ro['FStatus']=="Rejected" || $ro['FStatus']=="Closed"){
                           ?> 
                           
                    <tr>
                   <!--   <td>  <a href='reqgenpe.php?id=<?php// echo $ro['ReqNo']; ?> &name= <?php //echo $ro['UserName']; ?> &dor= <?php// echo $ro['DORequest']; ?> &dod=<?php// echo $ro['DORequirement']; ?>'><?php// echo  $ro["ReqNo"];  ?> </a></td> --> 
