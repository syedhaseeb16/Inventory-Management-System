...
<?php
  $ido=$_SESSION["id"];
              ...
              include('../config.php');
            $s1="SELECT * from draftby "; 
            $q1=mysqli_query($conn,$s1); 
    
               while($ro1=mysqli_fetch_array($q1)){
                if($ro1['ReqNo']==$draftno ){
                   
                $project=$ro1['Project'];
                $reqbefore=$ro1['DORequirement'];
                $supervisor=$ro1['Supervisor'];
                $reqcompany=$ro1['ReqCompany'];



                $origDate = $reqbefore;
                 
                $reqbefore = date("d-m-Y", strtotime($origDate));
                echo $reqbefore;
 ...
 <form action="getdata.php?id=<?php  echo $ido; ?> "   method="post">
  ...
  <p style="color:black ; " >Project :&nbsp;<INPUT id="project" placeholder="Purpose of order" value="<?php   echo $project; ?> " size="60" style="font-size: 10pt"  type="text" name="project"/>&nbsp;&nbsp;  Required before : <INPUT id="date"   size="6" type="date" value="<?php   echo $reqbefore; ?>"  style="font-size: 10pt"  name="dod" />
                ...
                Supervisor:<input id="1" value="<?php   echo $supervisor; ?>" size="15" style="font-size: 10pt" placeholder="Supervisor" name="super" type="text" list="super"  /> 
            <?php  
            include('../config.php');
                ...
                <?php
                 ...
                 ?>  
                  ...
                  Request From: <select  type="list"  name="fcompany" placeholder="dropdown"  >
                                       <option value="<?php   echo $reqcompany; ?> " selected> <?php   echo $reqcompany; ?>  </option>
        ...
        include('../config.php');
            ...
            $q1=mysqli_query($conn,$s1); 
               ...
               while($ro1=mysqli_fetch_array($q1)){
                ...
                $pname=$ro1['ProductName'];
                $pcode=$ro1['ProductCode'];
                $pqty=$ro1['ProductQty'];
                $punit=$ro1['ProductUnit'];
  ...
  ?>
    ...
    <TR>
      <TD><INPUT size="1" type="text" hidden="hidden" value="1" name="chk" id="00"/></TD>
                ...
                <TD><input id="1"  size="15" value="<?php   echo $pname; ?>   " style="font-size: 10pt"  name="pname[]" type="text" list="pname" onchange="setvalues(this.id,this.value)"   /> 
            <?php  
            include('../config.php');
            ...
            <datalist   id="pname">
             ...
             <TD><input id="2" value="<?php   echo $pcode; ?>" size="15" placeholder="part #" style="font-size: 10pt" name="pcode[]" type="text" list="pcode" onchange="setvaluesc(this.id,this.value)" /> 
            <?php  
            include('../config.php');
            $s1="SELECT * from current_state ORDER BY sr_no ASC"; 
            $q1=mysqli_query($conn,$s1); 
      ...
      <TD><INPUT id="4"  placeholder="QTY" value="<?php   echo $pqty; ?>" size="5"  type="text" style="font-size: 10pt"  name="qty[]" placeholer="QTY"/></TD>
      <TD><INPUT id="5" placeholder="UOM" value="<?php   echo $punit; ?>" style="font-size: 10pt" size="5" type="text" readonly name="unit[]"/></TD>
      
      <TD><INPUT id="6" placeholder="A.Qty" value="" size="5" style="font-size: 10pt" readonly type="text" name="aqty[]"/></TD>


      <TD><input  type="button"  " style="color:white; font-size: .9em; background-color: black; "  value="DeleteRow"  onclick="deleteRow(this)"/></TD>
...
<?php }}  ?>
  ...
  <input style="color:white; font-size: 10pt; background-color: black; class="btn btn-primary" type="submit" name="all" value="Submit Request">
   <input style="color:white; font-size: 10pt; background-color: black; class="btn btn-primary" type="submit" name="Draft" value="update Draft">
    <INPUT type="button" style="color:white; font-size: 10pt; background-color: black; class="btn btn-primary" value="Add More Rows"  onclick="addRow('dataTable')" />
</form>
