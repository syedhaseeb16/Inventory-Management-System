...
border-color: black; background-color: red  ; color: white; text-align: center;" value="Not Avalable" readonly size="9" style="font-size: 10pt"  type="text" /> 
       ...
       <div class="card mb-3">
          <div class="card-header">
            ...
            Request Analysis by StoreKeeper</div>
          <div class="card-body">
                ...
                <tbody>
                       ...
                       include('../config.php');
                        ...
                        $q=mysqli_query($conn,$s); 
                            ...
                            while($ro=mysqli_fetch_array($q))
                            {
                              if($ro['ReqNo']==$_GET['id'] && $ro['Qty_s']!="r")
                              {
...
<!-- <td>
  ...
  <input type="submit" style="background: green;" class="btn btn-primary" name="Issue" value="Issue" style="font-size: 8pt;" >
    <input type="submit" class="btn btn-primary" style="background: red;" name="Reject" value="Close" style="font-size: 8pt;" >
