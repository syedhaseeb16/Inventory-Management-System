...
<font size="2" color="black" style="font-weight: bold;"  >PO Number # :<?php echo "",$_GET['orderclose'];  ?>&nbsp;&nbsp;
<?php echo " | Total Amount:",$sum;  ?>&nbsp;&nbsp;
<?php if ($flag1==1){    echo " | Amount in Pkr:",$dsum, " | "; }  ?>
<?php
$req_no=$_GET['orderclose'];
                  ...
                  <tr>
                       ...
                       include('../config.php');
                        ...
                        $q=mysqli_query($conn,$s); 
                            ...
                            while($ro=mysqli_fetch_array($q))
                            {
                              if($ro['order_no']==$_GET['orderclose'])
                              {
                              ?>
...
border-color: transparent; background-color: transparent; color: solid black; text-align: center;" value="<?php echo $ro['unitprice']*$ro['pqty'];;  ?>" size="6"  type="text" style="font-size: 10pt"  name="qty[]" placeholer="QTY"/></TD>
                   ...
                   <TD><INPUT id="3"  placeholder="New unit price" style="font-size: 10pt;border: none;
border-color: transparent; background-color: transparent; color: solid black; text-align: center;" value="<?php echo $ro['unitprice'];  ?>" size="6"  type="text" style="font-size: 10pt"  name="unitpricen[]" placeholer="QTY"/></TD>
 <TD><INPUT id="3"  placeholder="QTY" style="font-size: 10pt;border: none;
border-color: transparent; background-color: transparent; color: solid black; text-align: center;" value="<?php echo $ro['pqty'];  ?>" size="6"  type="text" style="font-size: 10pt"  name="aqty[]" placeholer="QTY"/></TD>
 ...
 <Button style="color:white; font-size: .8em; background-color: green; "  class="item" data-toggle="tooltip" name="close" data-placement="top" title="Approve">Close Order </Button></a> 

</form>
<a href='powork1.php?idd=<?php echo $pon ;?>'><Button style="color:white; font-size: .8em; background-color: green; "  class="item" data-toggle="tooltip" data-placement="top" title="Approve">Cancel </Button></a> 
              <hr>
                       ...
                       include('../config.php');
                        ...
                        $sqlll="SELECT * from approval_chain" ; 
                         ...
                         $resultsss=mysqli_query($conn,$sqlll);
                            ...
                            {
                              if( $roa['order_no']==$_GET['orderclose'] ){?>
