...
$ac="SELECT * from approval_chain WHERE order_no = '".$pono."'"; 
    ...
    <?php 
                      ...
                      <td>
                                                ...
                                                <div class="table-data-feature">
                                                   ...
                                                   <a href='updatedeleteitem.php?update=<?php echo $pon ;?> &pname= <?php echo $ro['pname']; ?> &pcode=<?php echo $ro['pcode'];  ?>'><font name="update" style="color:white; font-size: .8em; background-color: green; " class="item" data-toggle="tooltip" data-placement="top" title="Delete">Update
                                                     </font></a>


                                                    <a href='updatedeleteitem.php?idel=<?php echo $pon;?>&pname=<?php echo $ro['pname'];?>&pcode=<?php echo $ro['pcode'];?>'> <font style="color:white; font-size: .8em; background-color: red; " class="item" data-toggle="tooltip" data-placement="top" title="Delete">Delete
                                                     </font></a>
                                                   </div>
...
<?php 
                      ...
                      if($apcn['stk']=='r'){ ?>
                        ...
                        <a href='updatedeleteitem.php?idel=<?php echo $pon;?>&pname=<?php echo $ro['pname'];?>&pcode=<?php echo $ro['pcode'];?>'> <Button style="color:white; font-size: .8em; background-color: black; " class="item" data-toggle="tooltip" data-placement="top" title="Delete">Add New Items/Make changes
                                                     </Button></a><hr>
                        <?php  
                         }
 ...
 if($rod['m1a']!='0' && $rod['m2a']!='0' && $rod['m3a']!='0')
                    {
                      if($rod['m1a']=='ok' && $rod['m2a']=='ok' && $rod['m3a']=='ok'){?>
                         ...
                         <a href='orderclose.php?orderclose=<?php echo $pon ;?>'><Button style="color:white; font-size: .8em; background-color: green; "  class="item" data-toggle="tooltip" data-placement="top" title="Approve">Order Close </Button></a> 
                   ...
                   if($rod['stk']=='r'){?>
                                                <form action="updatedeleteitem.php?update=<?php echo $pono ;?>"   method="post">
                                                    <div class="container">
                                                      <div class="row">
                                                        <div class="col-sm-5">
                                                          Remarks:<input type="text" size="45" name="remarksm1">
                                                        </div>
                                                        <div class="col-sm-1">
                                                          <div class="table-data-feature">
                                                
                                                   <Button name="astk" style="color:white; font-size: .8em; background-color: green; " class="item" data-toggle="tooltip" data-placement="top" title="Approve">Approve
                                                     </Button>
                 ...
                 if($rod['stk']=='ok'){?>
                                                ...
                                                <div class="table-data-feature">
                                                   ...
                                                   <a href='updatedeleteitem.php?update=<?php echo $pon ;?>'><Button name="am1" style="color:white; font-size: .8em; background-color: green; " disabled class="item" data-toggle="tooltip" data-placement="top" title="Approve">Approve
                                                     </Button></a>
